...
void SkinnedMesh::CreateComObjects(ID3D11Device* device, const char* fbxFilename) {
	...
	ResourceManager::CreateVsFromCso(device, "Data/Shader/SkinnedMeshVS.cso", vertexShader.ReleaseAndGetAddressOf(), inputLayout.ReleaseAndGetAddressOf(), inputElementDesc, ARRAYSIZE(inputElementDesc));
	ResourceManager::CreatePsFromCso(device, "Data/Shader/SkinnedMeshPS.cso", pixelShader.ReleaseAndGetAddressOf());
