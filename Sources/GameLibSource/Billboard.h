...
public:
	Billboard(ID3D11Device* device, const wchar_t* fileName)
	{
		...
		ResourceManager::CreateVsFromCso(device, "Data/Shader/BillboardVS.cso", vertexShader.GetAddressOf(), inputLayout.GetAddressOf(), ieDesc, ARRAYSIZE(ieDesc));

		// *******************************************************************************

		// Create Pixel Shader ***********************************************************

		ResourceManager::CreatePsFromCso(device, "Data/Shader/BillboardPS.cso", pixelShader.GetAddressOf());
