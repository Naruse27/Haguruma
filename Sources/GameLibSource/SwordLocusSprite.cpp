...
SwordLocusSprite::SwordLocusSprite(ID3D11Device* device, const wchar_t* fileName)
{
	...
	ResourceManager::CreateVsFromCso(device, "Data/Shader/SwordLocusVS.cso", &vertexShader, &inputLayout, ieDesc, ARRAYSIZE(ieDesc));
	//**************************************************************************

	//ピクセルシェーダーオブジェクト作成****************************************
	ResourceManager::CreatePsFromCso(device, "Data/Shader/SwordLocusPS.cso", &pixelShader);
	//**************************************************************************
