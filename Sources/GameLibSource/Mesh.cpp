...
//GeometricMesh::GeometricMesh(ID3D11Device* device, const char* fbxFilename, bool triangulate = false, float samplingRate = 0/*UNIT.25*/,
//	std::function<void(Mesh&, Mesh::Subset& subset)> draworderCallback = [](Mesh&, Mesh::Subset&) {}/*UNIT.99*/, bool avoidCreateComObjects = false/*UNIT.99*/)
//{
//
//}

void GeometricMesh::Init(ID3D11Device* device, BOOL handedCoordinateSystem)
{
	HRESULT hr = S_OK;
